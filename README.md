...
### Getting All Short URL's In Your Database or Redis Cache
...
- Body: No data is required to be sent in the request body
...
- Route: /urlCode
- Method: GET
- You don't need to be Authenticated to use this endpoint. Anyone can use it.
...
Success
You will be redirected to the website of the long URL you shortened earlier
